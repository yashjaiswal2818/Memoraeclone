...
export function AppleNav() {
  ...
  // Track scroll position for transparency changes
  useEffect(() => {
    const handleScroll = () => {
  ...
  const navItems = ["Product", "Features", "Pricing", "About", "Contact"];
    ...
    <>
      ...
      >
        <motion.div
          ...
          className="max-w-7xl mx-auto backdrop-blur-lg rounded-2xl border border-white/20 shadow-soft"
          style={{
            boxShadow: scrolled 
